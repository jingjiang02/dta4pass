...
class Trainer(object):
    def __init__(self, args):
        ...
        train_dataset_pin = get_segmentation_dataset('cityscape13', split='train', mode='train', **data_kwargs)
        train_dataset_pan = get_segmentation_dataset('synpass13', split='train', mode='train', **data_kwargs)
    ...
    def test_2(self):
        ...
        with torch.no_grad():
            ...
            logging.info("[TEST DensePASS13_FUSION END]  pixAcc: {:.3f}, mIoU: {:.3f}".format(pixAcc * 100, mIoU * 100))
